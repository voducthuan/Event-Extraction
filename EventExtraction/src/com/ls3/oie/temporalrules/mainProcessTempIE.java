...
public class mainProcessTempIE {
	...
	public static List<oieSentence> oieSentenceList(List<Sentence> pSentenceList){
		...
		for (int i = 1; i < pSentenceList.size(); i++) { // Starting from sentence 1
			...
			tempSentence.printSentenceContent();
	...
	*/
	...
	public static void start() throws IOException{
		...
		FileOutputStream fo = new FileOutputStream("data//tdata//output_files//allOutput_Records_test");
		OutputStreamWriter out = new OutputStreamWriter(fo, "utf-8");
		
		//String path="data//tdata//col_files//";
		//String path="data//tdata//col_files//bbc_test//";
		//String path="data//tdata//col_files//col_test//";
		String path="data//tdata//col_files//";
		String filetype="col";
		...
		for (int k = 0; k < filesLL.length; k++) {
			...
			//List<Sentence> sentenceList = SentenceList("data//tdata//col_files//bbc_test//"+f.getName());
			//List<Sentence> sentenceList = SentenceList("data//tdata//col_files//col_test//"+f.getName());
			List<Sentence> sentenceList = SentenceList("data//tdata//col_files//"+f.getName());
