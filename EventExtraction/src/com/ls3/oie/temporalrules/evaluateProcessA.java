...
public class evaluateProcessA {
	...
	public static void main(String args[]) throws IOException{
		...
		//FileInputStream fstream2 = new FileInputStream("data//tdata//output_files/finalOutput_train");
		//FileInputStream fstream2 = new FileInputStream("data//tdata//oie5//output//output_training.txt");
		//FileInputStream fstream2 = new FileInputStream("data//tdata//output_files/finalOutput_test"); //LS3RyIE
		//FileInputStream fstream2 = new FileInputStream("data//tdata//oie5//output/output_training_oie5.txt"); //OIE 5
		FileInputStream fstream2 = new FileInputStream("data//tdata//oie5//output/output_test_oie5.txt"); //OIE 5
