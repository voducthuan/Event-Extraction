...
import com.ls3.oie.temporalmodel.extractedPropositionOIE5;
...
public class mainProcessTempIE5 {
	...
	public static List<String> processResult(List<Sentence> pSentenceList, List<String> pAllResorceRecord, String pColID) throws IOException{
		...
		List<oie5Sentence> oie5SentenceList=oie5SentenceList(sentenceList, pColID); // -------------Can cap nhat phan nay
		...
		// start here	
		extractedRelationNodesOIE5 _relationNodes=new extractedRelationNodesOIE5();
		_relationNodes.setpOIESentence(oie5SentenceList);  // ---------------Can cap nhat phan nay
	...
	public static void start() throws IOException{
		...
		// Load resource
		//String inputResouce="data//tdata//oie5//TempEval3-train-all";
		String inputResouce="data//tdata//oie5//TempEval3-test-all";
		...
		br.close();
		FileOutputStream fo = new FileOutputStream("data//tdata//oie5/output//output_training_sample");
		OutputStreamWriter out = new OutputStreamWriter(fo, "utf-8");
		
		String path="data//tdata//oie5//raw_test//";
		String filetype="col";
		...
		for (int k = 0; k < filesLL.length; k++) {
			...
			List<Sentence> sentenceList = SentenceList("data//tdata//oie5//raw_test//"+f.getName());
			// Strating here
			String colID=f.getName();
			//process(sentenceList, allSourceRecord, colID);
			String allpatternFile="data//tdata//oie5//raw_test//";
			List<String> outputResult=processResult(sentenceList, allSourceRecord, colID); // Bo sung, normal sentences cho OIE5, sentencelist cols cho col features
			System.out.println();
